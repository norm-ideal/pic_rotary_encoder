; ROTATION ENCODER DECODER WITH MICROCHIP PIC 16F648A
...
MAIN
	...
	MOVLW   02H		; 0000 0010 ; 3BH ; 0011 1011
...
; Å@Note:	If the rotation charactor is sent directly, it drops some characters
